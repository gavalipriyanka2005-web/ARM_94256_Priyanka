...
/* ---------------------------------------------------------
 * Function: DWT_Init
 * Purpose : Initialize DWT Cycle Counter
 * ---------------------------------------------------------
 * DWT (Data Watchpoint and Trace) is a Cortex-M core feature.
 * CYCCNT counts the number of CPU clock cycles.
 * We use it to generate accurate delays.
 * --------------------------------------------------------- */
void DWT_Init(void)
{
 ...
 * ---------------------------------------------------------
 * This delay is CPU clock accurate (busy-wait delay).
 * --------------------------------------------------------- */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_12);
	  	  DWT_Delay_us(1000000); // 2sec delay
  }
  /* USER CODE END 3 */
}
